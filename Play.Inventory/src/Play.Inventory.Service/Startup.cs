...
namespace Play.Inventory.Service
{
    ...
    {
        private const string AllowedOrigenSetting = "AllowedOrigin";
        ...
        {
            services.AddMongo()
            // 2 collections or tables insede the same database of inventory.
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseCors(builder =>
                {
                    builder.WithOrigins(Configuration[AllowedOrigenSetting])
                        .AllowAnyHeader()
                        .AllowAnyMethod();
                });
            }
